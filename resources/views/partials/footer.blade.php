      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="row">
              <div class="col-md-6">
                    <p class="footer-heading mb-4 text-white">{{$settings->contact_number}}</p>
                    <p>SAT-THU 9am-5pm</p>
              </div>
              
              <div class="col-md-6">
                  <p class="footer-heading mb-4 text-white">{{$settings->contact_email}}</p>
                  <p>online support</p>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-12"><h3 class="footer-heading mb-4 text-white">Social Media</h3></div>
              <div class="col-md-12">
                <p>
                  ...
                  <a href="https://bd.linkedin.com/" class="p-2"><span class="icon-linkedin"></span></a>
                </p>
              </div>
          </div>
        </div>

...
<head>
    ...
    <!-- Fontawesome -->
    <script src="https://use.fontawesome.com/d9c4b82327.js"></script>

</head>
<body style="background-color: #DAE9EE">
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand text-info" href="{{ url('/') }}" style="font-size: 35px;">
                <h1>চাকরি <strong class="font-weight-bold text-danger">চাই</strong></h1>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li>
                            <a href="{{route('job.create')}}"><button class="btn btn-primary">Post a job</button></a>
                        </li>
                        @endif
